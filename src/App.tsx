...
export default function App() {
  const { profile, experience, education, skills, interests, awards, volunteering, blogs, interviews } = portfolioData;
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-[#fcfcfc] min-h-screen font-sans selection:bg-black selection:text-white">
      ...
      <main className="flex-1 lg:ml-64 p-8 lg:p-24 space-y-32 max-w-6xl">
        ...
        >
          <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 mb-6">Introduction</span>
        ...
        <section id="experience" className="pt-20">
          <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 mb-12 block">Background</span>
          <h2 className="text-3xl font-bold text-black mb-16 tracking-tight">Professional Experience</h2>
        ...
        <section id="education" className="pt-20">
          <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 mb-12 block">Academics</span>
          <h2 className="text-3xl font-bold text-black mb-16 tracking-tight">Education</h2>
        ...
        <section id="skills" className="pt-20">
          <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 mb-12 block">Expertise</span>
          <h2 className="text-3xl font-bold text-black mb-16 tracking-tight">Capabilities</h2>
        ...
        <section id="awards" className="pt-20">
          <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 mb-12 block">Recognition</span>
          <h2 className="text-3xl font-bold text-black mb-16 tracking-tight">Papers & Awards</h2>
        ...
        <section id="volunteering" className="pt-20">
          <span className="text-[10px] uppercase tracking-[0.4em] text-gray-400 mb-12 block">Community</span>
          <h2 className="text-3xl font-bold text-black mb-16 tracking-tight">Volunteering</h2>
          <div className="space-y-24">
        ...
        <footer className="pt-32 pb-16 text-[10px] uppercase tracking-[0.5em] text-gray-300 text-center lg:text-left">
